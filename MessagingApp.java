                ...
                for (int j = 0; j < contact[i].length; j++) {
                    if (contact[i][j] != null && contact[i][j].getName().equals(n1)) {
                        ...
                        for (int k = 0; k < msg_count; k++) {
                            if (messages[k] != null && messages[k].getReceiver().getName().equals(contact[i][j].getName())) {
                        ...
                        while (true) {
                            ...
                            if (num == 1) {
                                ...
                                int d = n.nextInt();
                                for (int k = 0; k < msg_count; k++) {
                                    if (messages[k] != null&& messages[k].getReceiver().getName().equals(contact[i][j].getName()) && d == messages[k].getMsg_id()) {
                            ...
                            if (num == 2) {
                                for (int k = 0; k < msg_count; k++) {
                                    if (messages[k] != null&& messages[k].getReceiver().getName().equals(contact[i][j].getName()) && messages[k].isStatus() == true && messages[k].getSeen().equals("seen")) {
                                        System.out.println(messages[k]);
                                    }
                                }
                            }
                            if (num == 3) {
                                for (int k = 0; k < msg_count; k++) {
                                    if (messages[k] != null&& messages[k].getReceiver().getName().equals(contact[i][j].getName()) && messages[k].isStatus() == true && messages[k].getSeen().equals("unseen")) {
                                        System.out.println(messages[k]);
                                    }
                                }
                            }
                            if (num == 4) {
                                for (int k = 0; k < msg_count; k++) {
                                    if (messages[k] != null&& messages[k].getReceiver().getName().equals(contact[i][j].getName()) && messages[k].isStatus() == true) {
                                        System.out.println(messages[k]);
                                    }
                                }
                            }
                            if (num == 5) {
                                for (int k = 0; k < msg_count; k++) {
                                    if (messages[k] != null && messages[k].getReceiver().getName().equals(contact[i][j].getName())&& messages[k].isStatus() == false) {
                                        System.out.println(messages[k]);
                                    }
                                }
                            }
